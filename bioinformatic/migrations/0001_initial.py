...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('enzymes', models.CharField(max_length=1000, verbose_name='Enzim Adı')),
                ('site', models.CharField(max_length=1000, verbose_name='Bölge')),
                ('laborant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bioinformatic.restrictionusermodel', verbose_name='Laborant')),
            ],
        ),
        migrations.CreateModel(
