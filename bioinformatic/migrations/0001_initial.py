...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('method', models.CharField(choices=[('', '------------'), ('MUSCLE', 'MUSCLE'), ('clustalw2', 'CLUSTALW2'), ('omega', 'ClustalOmega')], max_length=1000, verbose_name='Multiple Sekans Alignment Metodu')),
                ('algoritma', models.CharField(choices=[('', '------------'), ('nj', 'Neighbor Joining'), ('upgma', 'UPGMA')], max_length=1000, verbose_name='Algoritma')),
                ('file', models.FileField(upload_to='msa/', verbose_name='Fasta Dosyası')),
