        ...
        if form.is_valid():
            ...
            if palm_tools == "codeml":
                ...
                try:
                    ...
                    scores_path = os.path.join(BASE_DIR, "bioinformatic", "files", "scores.txt")
                    score_path = Path(scores_path)
                    max_likelihood_results = os.path.join(BASE_DIR, "bioinformatic", "files", "result_baseml.txt")
                    ...
                    try:
                        ...
                        cml.tree = os.path.join(BASE_DIR, "bioinformatic", "files", "tree.xml")
                        cml.ctl_file = os.path.join(BASE_DIR, "bioinformatic", "files", "codeml.ctl")
                        cml.out_file = os.path.join(BASE_DIR, "bioinformatic", "files", "result_baseml.txt")
                        cml.working_dir = os.path.join(BASE_DIR, "bioinformatic", "files")
                        cml.run(command=cml_exe, verbose=True)
                ...
                try:
                    ...
                    scores_path = os.path.join(BASE_DIR, "bioinformatic", "files", "scores.txt")
                    score_path = Path(scores_path)
                    max_likelihood_results = os.path.join(BASE_DIR, "bioinformatic", "files", "result_basemlg.txt")
                    ...
                    try:
                        ...
                        cml.tree = os.path.join(BASE_DIR, "bioinformatic", "files", "tree.xml")
                        cml.ctl_file = os.path.join(BASE_DIR, "bioinformatic", "files", "codeml.ctl")
                        cml.out_file = os.path.join(BASE_DIR, "bioinformatic", "files", "result_basemlg.txt")
                        cml.working_dir = os.path.join(BASE_DIR, "bioinformatic", "files")
                        cml.run(command=cml_exe, verbose=True)
