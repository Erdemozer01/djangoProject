...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AuthorMessagesModel',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, max_length=150, verbose_name='Konu:')),
                ('email', models.EmailField(help_text='Cevap email adresinize gönderilecektir.', max_length=254, verbose_name='Email adresiniz')),
                ('message', models.TextField(verbose_name='Mesaj')),
                ...
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author_messages_sender', to=settings.AUTH_USER_MODEL, verbose_name='Gönderen: ')),
            ],
            options={
